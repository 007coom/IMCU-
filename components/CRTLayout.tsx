...
export const CRTLayout: React.FC<CRTLayoutProps> = ({ children, isOn }) => {
  ...
  return (
    <div className="relative h-[100dvh] w-full bg-zinc-950 overflow-hidden font-vt323 text-amber-500 selection:bg-amber-500 selection:text-black touch-manipulation">
      ...
      <div className="relative z-10 h-full w-full p-2 md:p-8 flex flex-col crt-flicker">
